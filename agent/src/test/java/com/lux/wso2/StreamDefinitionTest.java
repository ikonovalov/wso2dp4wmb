...
public class StreamDefinitionTest {
    ...
    @Test
    public void createStreamDefinitionBuilderByClassName() throws StreamException {
        StreamDefinitionBuilderFactory.createFor(WMBEventsStreamDefinitionBuilder.class.getName());
    }

    @Test(expected = StreamException.class)
    public void createStreamDefinitionBuilderByClassNameError() throws StreamException {
        StreamDefinitionBuilderFactory.createFor(WMBEventsStreamDefinitionBuilder.class.getName() + "someMistakes");
    }
}
